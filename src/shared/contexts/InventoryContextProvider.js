  ...
  const [inventory, inventoryDispatch] = useReducer(reducer, {
    products: [
      ...
      },
      {
        ...
        comment: [],
        brand: "2",
        tags: ["kitchen", "bathroom", "bedroom", "livingroom"],
      },
      {
        productId: "9",
...

      {
        ...
        comment: [],
        brand: "3",
        tags: ["kitchen", "bedroom", "livingroom"],
      },
...

      {
        ...
        comment: [],
        brand: "6",
        tags: ["livingroom", "bedroom", "outdoors"],
      },
...

      {
        ...
        comment: [],
        brand: "9",
        tags: ["bathroom", "bedroom", "livingroom"],
      },
