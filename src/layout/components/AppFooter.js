        ...
        <div className='third'>
          <div className='right'>
            ...
            <div className='onlinestores'>
              ...
              <div className='links'>
                <a href="https://shopee.ph/uni_adj.appliancestrading" className='shopee'>Shopee</a>
                <a href="https://www.lazada.com.ph/shop/uni-adj-appliances-trading/?spm=a2o4l.pdp_revamp.seller.1.27dcb1b6B3gJV0&itemId=2048801456&channelSource=pdp" className='lazada'>Lazada</a>
              </div>
            </div> 
          </div>
